...
export interface AuditLogPage {
  ...
  pagination: {
    ...
    hasMore: boolean;
    /** Offset to request the next page, or null if there is no next page. */
 ...
 */
/** Options for {@link listBountyAuditLogs}. */
export interface ListBountyAuditLogsOptions {
  limit?: number;
  offset?: number;
}
...
export function listBountyAuditLogs(
  bountyId: string,
  options: ListBountyAuditLogsOptions = {},
): AuditLogPage {
...
/** Filter options for {@link listAllAuditLogs}. */
...
/**
 * Retrieves a paginated, filterable view of audit log records across every bounty.
 */
...
export interface GlobalMetrics {
  ...
  /** Total protocol fees collected across all released bounties. */
