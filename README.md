...
Merges to `main` that touch contracts/ automatically trigger a testnet deployment via the [testnet-deploy.yml](.github/workflows/testnet-deploy.yml) workflow.

### Setup

1. Add your Soroban testnet secret key as a GitHub secret: `TESTNET_SECRET_KEY`
2. Merge a contract change to `main` to trigger the deployment
...
soroban contract deploy \
  --wasm contracts/target/wasm32-unknown-unknown/release/contract.wasm \
  --source deployer \
  --network testnet
```
