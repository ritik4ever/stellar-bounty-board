...
function App() {
  ...
  async function handleExport() {
    ...
    try {
      ...
      a.href = url;
      a.download = filename ?? 'bounties_export.csv';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
    } catch (err) {
      toast.error(err instanceof Error ? err.message : 'Failed to export bounties.');
    } finally {
          ...
          <div className="board-filters">
            ...
            <div className="export-button">
              <button
                ...
                className={
                  isExporting ? 'primary-button secondary-button--disabled' : 'primary-button'
                }
              >
                {isExporting ? (
                  <svg
                    ...
                    fill="currentColor"
                  >
                    <path d="M9 5l7 7-2 2-7-7 2-2zM9 13l7 7-2 2-7-7 2-2z" />
                  </svg>
                ) : (
                  'Export CSV'
                )}
