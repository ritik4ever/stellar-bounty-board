...
function App() {
  ...
  const renderActionButton = useCallback(
    ...
    // The handlers read live wallet state, so they must be re-created whenever
    // that state changes; a stale closure here would keep `freighter` from the
    // first render and block Release/Refund even after connecting.
    [refresh, handleReserve, handleSubmit, handleRelease, handleRefund]
  );
