...
import { Routes, Route, useNavigate as useRouterNavigate, useLocation } from 'react-router-dom';
import { FolderGit2, Moon, Plus, Rocket, Search, Sun } from 'lucide-react';
...
import { type Bounty, type BountyStatus, type OpenIssue } from './types';
...
function AppBoard() {
  ...
  // Derive pathname from react-router location (keeps custom routing logic working)
