...
export const STELLAR_PUBLIC_KEY_HINT =
  ...
  open: [
    {
      action: 'reserve',
      label: 'Reserve',
      title: 'Claim this bounty as a contributor.',
  ...
  reserved: [
    {
      action: 'submit',
      label: 'Submit',
      title: 'Attach a pull request or demo link.',
      requires: 'contributor',
    },
  ],
  submitted: [
    {
      action: 'release',
      label: 'Release',
      title: 'Release payout after review.',
      requires: 'maintainer',
    },
    {
      action: 'refund',
      label: 'Refund',
      title: 'Refund escrow instead of releasing.',
      requires: 'maintainer',
    },
  ],
  released: [],
  ...
  expired: [
    {
      action: 'refund',
      label: 'Refund',
      title: 'Refund an expired bounty.',
      requires: 'maintainer',
    },
  ],
};
