...
/// Maximum bounty amount allowed
pub const MAX_BOUNTY_AMOUNT: i128 = i128::MAX / 2;
...
fn panic_error(err: ContractError) -> ! {
    match err {
        ContractError::NotInitialized => panic!("not initialized"),
        ContractError::AlreadyInitialized => panic!("already initialized"),
        ContractError::InvalidAmount => panic!("InvalidAmount"),
        ContractError::AmountTooSmall => panic!("AmountTooSmall"),
        ContractError::DeadlineMustBeInTheFuture => panic!("DeadlineMustBeInTheFuture"),
        ContractError::BountyNotFound => panic!("BountyNotFound"),
        ContractError::BountyNotOpen => panic!("BountyNotOpen"),
        ContractError::BountyMustBeReserved => panic!("BountyMustBeReserved"),
        ContractError::BountyMustBeSubmitted => panic!("BountyMustBeSubmitted"),
        ContractError::ContributorMismatch => panic!("ContributorMismatch"),
        ContractError::MaintainerMismatch => panic!("MaintainerMismatch"),
        ContractError::BountyAlreadyFinalized => panic!("BountyAlreadyFinalized"),
        ContractError::BountyNotExpiredYet => panic!("BountyNotExpiredYet"),
        ContractError::BountyExpired => panic!("BountyExpired"),
        ContractError::MissingContributor => panic!("MissingContributor"),
        ContractError::CannotExtendFinalizedBounty => panic!("CannotExtendFinalizedBounty"),
        ContractError::DeadlineMustAdvance => panic!("DeadlineMustAdvance"),
        ContractError::DisputeWindowNotMet => panic!("DisputeWindowNotMet"),
        ContractError::DisputeWindowOverrideTooSmall => panic!("DisputeWindowOverrideTooSmall"),
        ContractError::DisputeWindowOverrideTooLarge => panic!("DisputeWindowOverrideTooLarge"),
        ContractError::FeeRecipientNotSet => panic!("FeeRecipientNotSet"),
        ContractError::ArbiterNotSet => panic!("ArbiterNotSet"),
        ContractError::NotArbiter => panic!("NotArbiter"),
        ContractError::ContractIsPaused => panic!("ContractIsPaused"),
        ContractError::TokenNotAllowed => panic!("TokenNotAllowed"),
        ContractError::NotAdmin => panic!("NotAdmin"),
        ContractError::NoPendingArbiter => panic!("NoPendingArbiter"),
        ContractError::TimelockNotElapsed => panic!("TimelockNotElapsed"),
    }
}
...
impl StellarBountyBoardContract {
    ...
    /// Returns the currently configured arbiter Address.
    ...
    /// Returns the currently configured dispute window duration (in seconds).
    /// This is a read-only view function that requires no authentication.
    /// Panics if the contract has not been initialized.
